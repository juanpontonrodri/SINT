        ...
        for (Document xmlDocument : map.values()) {
          ...
          try{
            ...
            for (int co=0; co<nlAlbums.getLength(); co++) {
                ...
                if (!albums.contains(new Album(albumName, albumCountry, albumSinger, albumaid,albumReview,year))) {//we check and add to the list
                    albums.add(new Album(albumName, albumCountry, albumSinger, albumaid,albumReview,year));
                    }
